...
<section class="hero">
    <div class="container">
        ...
        <a href="https://privotech.co.uk/contact" class="btn btn-accent">Get In Touch</a>
    </div>
</section>
        ...
        <div class="projects-grid">
            <div class="project-card">
                ...
                <div class="project-content">
                    ...
                    <p>A custom e-commerce solution with advanced inventory management and payment processing.</p>
                    <a href="projects.php" class="read-more">View Project →</a>
                </div>
            </div>
            <div class="project-card">
                ...
                <div class="project-content">
                    ...
                    <p>A comprehensive system for managing patient records, appointments, and billing.</p>
                    <a href="projects.php" class="read-more">View Project →</a>
                </div>
            </div>
            <div class="project-card">
                ...
                <div class="project-content">
                    ...
                    <p>Real-time financial data visualization and reporting tools for investment firms.</p>
                    <a href="projects.php" class="read-more">View Project →</a>
                </div>
            </div>
        </div>
        <div style="text-align: center; margin-top: 40px;">
            <a href="https://privotech.co.uk/projects" class="btn">View All Projects</a>
        </div>
    </div>
</section>
...
<section id="about">
    <div class="container">
        <div class="about-content">
           ...
           <a href="https://privotech.co.uk/about" class="btn">Learn More About Us</a>
            </div>
...
<section class="contact-section">
    <div class="container">
        <div class="section-title">
            ...
            <p>Contact us today to discuss your requirements and get a free consultation.</p>
            <a href="https://privotech.co.uk/contact" class="btn btn-accent" style="margin-top: 20px;">Get Started</a>
        </div>
    </div>
</section>
