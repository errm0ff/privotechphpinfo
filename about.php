<?php
$page_title = "About Us - Privotech";
$page_description = "Learn about Privotech's mission, values, and the team behind our success in delivering innovative technology solutions.";
include 'header.php';
?>
    ...
    <div class="container">
        <div class="about-content">
            <div class="about-text">
                ...
                <h2 style="margin-top: 30px;">Our Values</h2>
                <ul style="list-style: none; margin: 20px 0; color: var(--text-light);">
                    <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: var(--secondary);">✓</span>
                        <strong>Innovation:</strong> We stay at the forefront of technology trends
                    </li>
                    <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: var(--secondary);">✓</span>
                    ...
                    <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: var(--secondary);">✓</span>
                        <strong>Collaboration:</strong> We work as partners with our clients
                    </li>
                    <li style="margin-bottom: 10px; padding-left: 20px; position: relative;">
                        <span style="position: absolute; left: 0; color: var(--secondary);">✓</span>
...
<!-- Stats Section Alternative -->
<section class="projects-section">
    <div class="container">
        <div class="section-title">
            <h2>Our Achievements</h2>
            <p>Building success stories one project at a time</p>
        </div>
